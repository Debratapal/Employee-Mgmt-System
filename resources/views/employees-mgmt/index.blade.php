    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <form class="form-horizontal" role="form" method="POST" action="{{ route('report.excel') }}">
                {{ csrf_field() }}
                <input type="hidden" value="2020/06/10" name="from" />
                <input type="hidden" value="2020/07/15" name="to" />
  ...
  <div class="box-body">
      ...
      <form method="POST" action="{{ route('employee-management.search') }}">
         ...
         @component('layouts.search', ['title' => 'Search'])
          @component('layouts.two-cols-search-row', ['items' => ['empname'], 
          'oldVals' => [isset($searchingVals) ? $searchingVals['empname'] : '']])
          @endcomponent
        @endcomponent
      </form>
    <div id="example2_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
          ...
          <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
            <thead>
              <tr role="row">
                ...
                <th width="10%" class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Name: activate to sort column descending" aria-sort="ascending">Employee Id</th>
                ...
                <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Age: activate to sort column ascending">MobNumber</th>
                ...
                <th width="8%" class="sorting hidden-xs" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="HiredDate: activate to sort column ascending">Birthdate</th>
            ...
            @foreach ($employees as $employee)
                <tr role="row" class="odd">
                  ...
                  <td class="sorting_1">{{ $employee->empid }}</td>
                  <td class="hidden-xs">{{ $employee->empname}}</td>
                  <td class="hidden-xs">{{ $employee->mobnumber }}</td>
      ...
      <div class="row">
        <div class="col-sm-5">
          <div class="dataTables_info" id="example2_info" role="status" aria-live="polite">Showing 1 of {{count($employees)}} entries</div>
        </div>
        <div class="col-sm-7">
