                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('employee-management.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('empid') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="empid" type="text" class="form-control" name="empid" maxlength="5" value="{{ old('empid') }}" required autofocus> <span id="errmsg"></span>
                                @if ($errors->has('empid'))
                        ...
                        <div class="form-group{{ $errors->has('empname') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="empname" type="text" class="form-control" name="empname" value="{{ old('empname') }}" required> <span id="errmsg1"></span>
                        ...
                        <div class="form-group{{ $errors->has('mobnumber') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="mobnumber" type="text" class="form-control" name="mobnumber" placeholder="7854896587" maxlength="10" pattern="[0-9]{10}" required> <span id="errmsg2"></span>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="text" class="form-control" name="email" value="{{ old('email') }}" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required>
